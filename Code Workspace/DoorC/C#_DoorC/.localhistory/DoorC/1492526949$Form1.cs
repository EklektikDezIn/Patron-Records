    ...
    public partial class Form1 : Form
    {
        ...
        private void addBox()
        {
            Func<int> del = delegate()
            {
                ...
                this.Controls.Add(new RadioButton() { Name = "rawD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0]+20, dtxtp[1] + 450), Size = new System.Drawing.Size(50, 50), Text = "Raw" });
            ...
            if (result.IsCompleted)
            {
                ...
                while (client.Connected)
                {
                    ...
                    if (stream.CanRead)
                    {
                        ...
                        RadioButton r = (RadioButton)this.Controls["raw" + thisbox];
                        if (r.Checked == true)
                        {
