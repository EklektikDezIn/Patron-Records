...
# Micah Richards
# 07/11/17
# Purpose: Handles work with Excel files for general purposek
#           
###############################################################*/
...

{
    class Excel
    {
        ...
        {
            File = new FileInfo(@"C:\Users\Micah Richards\Google Drive\Work\Library\Patron Records\DoorC\Output\" + filename + ".xlsx");
        }
