    ...
    public partial class Form1 : Form
    {
        ...
        private void addBox()
        {
            Func<int> del = delegate()
            {
                ...
                this.Controls.Add(new TrackBar() { Name = "tbD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0], dtxtp[1] + 420), Size = new System.Drawing.Size(170, 30), Maximum = 250, Value = 10 });
                TrackBar t = (TrackBar) this.Controls["tbD" + dtxtp[2]];
                t.Scroll += (s, e) => { 
                    var sender = s as TrackBar;
                    int id = 0;
                    Int32.TryParse((sender as TrackBar).Name.ToString().Substring(3),out id);
                    Label l = (Label)this.Controls["lbtbD" +id]; 
                    int val = (sender as TrackBar).Value;
                    l.Text = val.ToString(); 
                    trigger[id] = val;
                };
                this.Controls.Add(new Label() { Name = "lbtbD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0] + 170, dtxtp[1] + 420), Size = new System.Drawing.Size(30, 30), Text = "10" });
                this.Controls.Add(new RadioButton() { Name = "rawD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0]+20, dtxtp[1] + 450), Size = new System.Drawing.Size(50, 50), Text = "Raw", Checked = true });
                this.Controls.Add(new RadioButton() { Name = "cleD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0]+70, dtxtp[1] + 450), Size = new System.Drawing.Size(60, 50), Text = "Clean" });
                this.Controls.Add(new RadioButton() { Name = "jpaD" + dtxtp[2], Location = new System.Drawing.Point(dtxtp[0]+130, dtxtp[1] + 450), Size = new System.Drawing.Size(90, 50), Text = "Patron" });
        ...
        void BluetoothClientConnectCallback(IAsyncResult result)
        {
            ...
            addBox();
            updateUI(thisbox, "Connected." + System.Environment.NewLine);
            ...
            ws.Cells["C1"].Value = DateTime.Now.ToString(@"MM\/dd\/yyyy hh:mm:ss tt");
            ...
            if (result.IsCompleted)
            {
                ...
                while (client.Connected)
                {
                    ...
                    if (stream.CanRead)
                    {
                        ...
                        RadioButton r = (RadioButton)this.Controls["cleD" + thisbox];
                        if (r != null)
                        {
                            foreach (string dist in msg)
                            {
                                ...
                                {
                                    if (isPerson && r.Checked)
                                    {
                                        updateUI(thisbox, "0" + System.Environment.NewLine);
                                    }
                                    stand[thr]++;
                                }
                                else
                                {
                                    if (!isPerson && r.Checked)
                                    {
                                        updateUI(thisbox, "150" + System.Environment.NewLine);
                                    }
                                    pass[thr]++;
                                }
                            }
                            ...
                            if (isPerson)
                            {
                                if (pass[thr] > 50)
                                {
                                    ...
                                    stand[thr] = 0;
                                    ws.InsertRow(1, thr);
                                    ws.Cells[(char)('A'+thr)+ "1"].Value = DateTime.Now.ToString(@"MM\/dd\/yyyy hh:mm:ss tt");
                                    r = (RadioButton)this.Controls["jpaD" + thisbox];
                                    if (r != null)
                                    {
                                        updateUI(thisbox, "Patron at " + DateTime.Now.ToString("h:mm:ss tt") + System.Environment.NewLine);// + DateTime.Now.ToString("h:mm:ss tt"));
                                    }
                                    try
                                    {
                                        pck.Save();
                        ...
                        r = (RadioButton)this.Controls["rawD" + thisbox];
                        if (r != null)
                        {
                            if (r.Checked)
                            {
